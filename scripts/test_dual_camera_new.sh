...
rm -f /dev/shm/pet_camera_frames_day /dev/shm/pet_camera_stream_day
rm -f /dev/shm/pet_camera_frames_night /dev/shm/pet_camera_stream_night

# Start Camera 0 (Day)
echo "[Camera 0] Starting..."
SHM_NAME_NV12=/pet_camera_frames_day SHM_NAME_H264=/pet_camera_stream_day \
    /app/smart-pet-camera/build/camera_daemon_drobotics -C 0 > /tmp/daemon_cam0.log 2>&1 &
CAM0_PID=$!
...
SHM_NAME_NV12=/pet_camera_frames_night SHM_NAME_H264=/pet_camera_stream_night \
    /app/smart-pet-camera/build/camera_daemon_drobotics -C 1 > /tmp/daemon_cam1.log 2>&1 &
CAM1_PID=$!
...
ls -lh /dev/shm/pet_camera_frames_* /dev/shm/pet_camera_stream_* 2>/dev/null || echo "No shared memory segments found"
