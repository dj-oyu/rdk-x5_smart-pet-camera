...
## Overview
Go (pion/webrtc v3) によるWebRTC H.264パススルー配信、MJPEG配信、録画、comic自動生成。
...
## Key Details
- SPS/PPS caching for mid-stream client joins
...
- Recording: H.264 NAL → .h264 → ffmpeg → .mp4, heartbeat 3s timeout, max 30min
