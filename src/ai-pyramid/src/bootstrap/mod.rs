use crate::application::{AppContext, PhotoStoreRepository};
...
pub async fn run(args: Args) {
    ...
    let (pet_event_tx, _) = tokio::sync::broadcast::channel::<crate::application::PetEvent>(64);
    ...
    let training_state = crate::training::api::TrainingState {
        db: db_handle,
    ...
    let training_router = crate::training::api::router(training_state);
