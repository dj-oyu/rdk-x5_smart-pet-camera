...
mod tests {
    ...
    async fn insert_test_photo(
        ...
        repo.store_source_photo(filename, ts, Some(pet_id))
            .await
            .unwrap();
        repo.apply_observation(filename, true, caption, behavior)
            .await
            .unwrap();
    }
    ...
    async fn mcp_photo_download() {
        ...
        state
            .store
            .store_source_photo("a.jpg", dt(2026, 3, 21, 10, 0, 0), Some("chatora"))
            .await
            .unwrap();
