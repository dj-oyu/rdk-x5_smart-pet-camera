...
typedef struct {
  double
      day_to_night_threshold; // brightness threshold (mean 0-255) to go night
  double night_to_day_threshold; // brightness threshold (mean 0-255) to go day
  double
      day_to_night_hold_seconds; // required duration below threshold to switch
  double
      night_to_day_hold_seconds; // required duration above threshold to switch
