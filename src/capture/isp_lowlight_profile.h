...
#define PROFILE_DARK \
    { .denoise_3d = 120, .denoise_2d = 0.7f }

// DIM zone: Moderate noise reduction
#define PROFILE_DIM \
    { .denoise_3d = 115, .denoise_2d = 0.5f }
...
#define PROFILE_NORMAL \
    { .denoise_3d = 113, .denoise_2d = 5.0f }
...
#define DEFAULT_HYSTERESIS                                                   \
    {                                                                        \
        .correction_on_threshold = 50.0f, .correction_off_threshold = 70.0f, \
        .hold_time_on_sec = 1.0f, .hold_time_off_sec = 2.0f                  \
    }
